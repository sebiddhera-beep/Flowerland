...
def _load_plant_ids():
    """plants_master.csv 에서 PID 목록을 읽는다. 없으면 P001만."""
    ids = []
    try:
        with open(_MASTER_CSV, encoding="utf-8") as f:
