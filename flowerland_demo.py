...
def header():
    ...
    with c1:
        ...
        if logo:
            ...
            if clickable_image(logo, f"logohome_{page}", fit="111% 114%",
                               bg="#F5F5F5", pad="2px", pos="center",
                               height="37px", hug=True):
                go("home")
        else:
...
if page == "home":
    ...
    with b1:
        if asset("MBTI.png"):
            if clickable_image(asset("MBTI.png"), "imgbtn_face", "351/419"):
    ...
    ICON_ASPECT = ["165/214", "172/222", "172/222", "172/222"]
